...
<x-app-layout>
    <x-slot name="StyleResource">
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('plugin/dropzone-5.7.0/dist/dropzone.css') }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group form-float" style="margin-bottom: 0">
                        <div class="form-line">
                            ...
                            value="{{ !empty($Q) ? $Q->nama_wisata : '' }}">
                            <label class="form-label" style="color: #000">Nama Wisata</label>
                        </div>
                    </div>
                    <br>
                    <div class="form-group form-float" style="margin-bottom: 0">
                    ...
                    <div class="form-group form-float" style="margin-bottom: 0">
                        <div class="form-line">
                            <span>Desa</span>
                            <select class="form-control show-tick" id="desa">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group form-float" style="margin-bottom: 0">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="title" id="koordinat"
                                    value="{{ !empty($Q) ? $Q->koordinat : '' }}">
                                    <label class="form-label" style="color: #000">Koordinat Tempat</label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <img src="{{ asset(!empty($Q) ? 'Images_assets/wisata/' . $Q->gambar : 'images/default.jpg') }}"
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="body video-prev">
                                    <video
                                    src="{{ asset(!empty($Q) ? 'Images_assets/vidio_wisata/' . $Q->vidio : '') }}"
    ...
    <x-slot name="ScriptResource">
        ...
        <script type="text/javascript" src="{{ asset('plugin/dropzone-5.7.0/dist/dropzone.js') }}"></script>
        <script src="{{ asset('Admin') }}/js/pages/forms/advanced-form-elements.js"></script>
        <script src="{{ asset('Admin') }}/js/pages/forms/editors.js"></script>
        <script type="text/javascript">
                    // $('.video-prev').hide();
                    const Q_kecamatan = "{{ !empty($Q) ? $Q->kecamatan : '' }}";
                    const Q_desa = "{{ !empty($Q) ? $Q->Q_desa : '' }}";
                    ...
                    $(".btn-save").click(function() {
                        ...
                        form_data.append('nama_wisata', $("#nama").val());
                        form_data.append('alamat', $("#alamat").val());
                        form_data.append('kecamatan', $("#kecamatan").val());
                        form_data.append('desa', $("#desa").val());
                        form_data.append('koordinat', $("#koordinat").val());
                        ...
                        ajax_save_redirect(base_url + '/seendWisata', form_data, redirect);
