    ...
    <x-card>
        ...
        <x-slot name="Content">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <a href="{{ asset(!empty($Q) ? 'Images_assets/budaya/' . $Q->gambar : 'images/default.jpg') }}">
                            <div class="body">
                ...
                <div class="col-md-6">
                    <h3><span class="block__title">{{ !empty($Q) ? $Q->nama_budaya : '' }}</span></h3>
                    <ul class="list-detail">
                        <li><span>
                            <stong>Alamat</stong>
                        </span>: {{ !empty($Q) ? $Q->alamat_asal : '' }}</li>
                        <li><span>
        ...
        <div class="row">
            <div class="col-md-12" {{ !empty($Q->vidio) ? '' : 'hidden' }}>
                <div class="card">
                    <div class="body">
                        <video src="{{ asset(!empty($Q) ? 'Images_assets/vidio_budaya/' . $Q->vidio : '') }}"
