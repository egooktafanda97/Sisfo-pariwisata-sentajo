    ...
    <x-card>
        ...
        <x-slot name="Content">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <a href="{{ asset(!empty($Q) ? 'Images_assets/wisata/' . $Q->gambar : 'images/default.jpg') }}">
                            <div class="body">
                ...
                <div class="col-md-6">
                    <h2><span class="block__title">{{ !empty($Q) ? $Q->nama_wisata : '' }}</span></h2>
                    <ul class="list-detail">
                        ...
                        <li><span>
                                <stong>Desa</stong>
                            </span>: {{ !empty($Q) ? \App\Models\Desa::whereidKel($Q->desa)->first()['nama'] : '' }}</li>
                    </ul>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12" {{ !empty($Q->vidio) ? '' : 'hidden' }}>
                    <div class="card">
                        <div class="body">
                            <video src="{{ asset(!empty($Q) ? 'Images_assets/vidio_wisata/' . $Q->vidio : '') }}"
                                height="200px" width="100%" class="video-preview" controls="controls" />
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
