                        ...
                        <tbody>
                            ...
                            @foreach ($Q as $item)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->kategori }}</td>
                                    <td>
                                        <img src="{{ asset('produk/' . $item->images) }}" width="50px"
                                            height="50px" />
                                    </td>
                                    <td style="width: 200px">
                                        <a href="{{ url('/preview_produk/' . $item->id) }}"
                                            class="btn bg-primary btn-circle waves-effect waves-circle waves-float edit">
                                            <i class="material-icons">visibility</i>
                                        </a>
                                        <a href="{{ url('create_produk/' . $item->id) }}"
